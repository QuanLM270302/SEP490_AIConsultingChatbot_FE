    ...
    <aside className="hidden w-64 shrink-0 overflow-hidden rounded-3xl bg-white shadow-lg shadow-green-100/60 dark:bg-zinc-950 dark:shadow-black/50 lg:flex">
      <div className="flex h-full w-full flex-col justify-between gap-6 p-6">
        <div className="space-y-6">
          ...
          {/* Account — Profile & Log out (hover to reveal) */}
          <div className="mt-5 border-t border-zinc-200 pt-4 dark:border-zinc-800">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-400">
              Account
            </p>
            <div className="max-h-0 overflow-hidden opacity-0 transition-[max-height,opacity] duration-200 group-hover/nav:max-h-40 group-hover/nav:opacity-100 mt-2 space-y-1">
            <Link
              href="/profile"
