export const translations = {
  vi: {
    ...
    selectRoleForUser: 'Chọn vai trò đã được cấu hình quyền để gán cho người dùng.',
  ...
  en: {
    ...
    selectRoleForUser: 'Select a role with configured permissions to assign to this user.',
