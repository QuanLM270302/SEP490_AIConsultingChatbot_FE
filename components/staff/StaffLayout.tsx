...
export function StaffLayout({ children }: StaffLayoutProps) {
  ...
  return (
    <div className="flex min-h-dvh w-full min-w-0 bg-linear-to-br from-zinc-50 via-white to-blue-50/30 px-3 py-4 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 sm:px-5 sm:py-5 lg:px-8 lg:py-6">
